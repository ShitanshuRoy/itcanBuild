...
var createCart = exports.createCart = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items, id) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            totalPrice = itemsDetail.map(function (val) {
              return val.price;
            }).reduce(function (a, b) {
              return a + b;
            });
            totalDiscountPrice = itemsDetail.map(function (val) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt("return", _extends({}, cart._doc, { itemDetails: itemsDetail }));
